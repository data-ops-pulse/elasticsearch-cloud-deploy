...
=======
  masters_count = local.singlenode_mode ? 0 : length(keys(var.masters_blue_count)) + length(keys(var.masters_count)) + length(keys(var.data_voters_count)) + length(keys(var.data_voters_blue_count))
>>>>>>> master
